...
describe('MethodRegistry', () => {
  ...
  describe('execute', () => {
    it('should throw UnknownMethod for unregistered methods', async () => {
      await expect(registry.execute('unknownMethod', {}, context))
    ...
    describe('authentication checks', () => {
      ...
      it('should check authentication for non-exempt methods', async () => {
        ...
        await expect(registry.execute('secureMethod', {}, context))
          .rejects.toThrow('DesktopNotAuthenticated: Desktop app is not authenticated')
    ...
    describe('logging', () => {
      ...
      it('should log errors', async () => {
        ...
        await expect(registry.execute('errorMethod', {}, context))
