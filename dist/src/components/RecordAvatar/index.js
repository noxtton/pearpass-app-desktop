...
import { AvatarAlt, AvatarContainer, AvatarImage, FavoriteIcon, SelectedAvatarContainer } from './styles';
 ...
 * }} props
 */
export const RecordAvatar = ({ websiteDomain, initials, size = 'md', isSelected = false, isFavorite = false, color, testId }) => {
