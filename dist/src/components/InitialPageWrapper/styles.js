...
export const Background = styled.div `
  position: relative;
  background-color: ${({ theme, isAuthScreen }) => isAuthScreen ? theme.colors.grey500.mode1 : theme.colors.black.mode1};
  width: 100%;
  height: 100%;
  overflow: hidden;
`;
...
export const PageContent = styled.div `
  ...
  align-items: ${({ isAuthScreen }) => isAuthScreen ? 'center' : 'flex-start'};
`;
