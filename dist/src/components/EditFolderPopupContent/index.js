    ...
    const menuItems = useMemo(() => [
        {
            ...
            type: 'rename',
            icon: FolderIcon,
            onClick: () => setModal(html `<${CreateFolderModalContent}
        ...
        },
        {
            ...
            type: 'delete',
            icon: DeleteIcon,
            onClick: () => setModal(html `<${ConfirmationModalContent}
              primaryAction=${() => {
                deleteFolder(name);
                closeModal();
            }}
              ...
              text=${i18n._('This action will permanently delete the folder and all items contained within it. Are you sure you want to proceed?')}
            />`)
        }
    ], []);
