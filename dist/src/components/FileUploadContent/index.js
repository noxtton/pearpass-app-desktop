...
export const FileUploadContent = ({ accepts, isTypeImage, handleFileChange }) => {
    ...
    ${isFileSizeWarning
        ? html ` <${FileSizeWarning}>
          ...
          ${t(`Your picture is too large. Please upload one that’s ${MAX_FILE_SIZE_MB} MB or smaller.`)}
        <//>`
        : html `<${FileSizeWarning}>
