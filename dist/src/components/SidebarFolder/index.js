...
import { ArrowDownIcon, ArrowUpIcon, FolderIcon, KebabMenuIcon, PlusIcon } from '../../lib-react-components';
import { EditFolderPopupContent } from '../EditFolderPopupContent';
import { PopupMenu } from '../PopupMenu';
import { AddIconWrapper, FolderName, NestedFolder, NestedFoldersContainer, NestedItem } from './styles';
/**
 * @param {{
 *  isOpen: boolean
 *  onClick: () => void
 ...
 * }} props
 */
export const SidebarFolder = ({ isOpen, onClick, onDropDown, onAddClick, isRoot, name, icon: Icon, isActive, testId }) => {
