...
jest.mock('../../../lib-react-components', () => ({
    ArrowDownIcon: () => _jsx("div", { "data-testid": "arrow-down-icon" }),
    ArrowUpIcon: () => _jsx("div", { "data-testid": "arrow-up-icon" })
}));
jest.mock('../MenuDropdownItem', () => ({
    MenuDropdownItem: ({ item }) => (_jsx("div", { "data-testid": "menu-dropdown-item", children: item.name }))
}));
...
describe('MenuDropdownLabel', () => {
    ...
    const renderComponent = (props) => render(_jsx(ThemeProvider, { children: _jsx(MenuDropdownLabel, { isHidden: false, isOpen: false, setIsOpen: mockSetIsOpen, ...props }) }));
