...
import { ModalActions, ModalContainer, ModalContent, ModalDescription, ModalHeader, ModalTitle } from './styles';
import { AlertBox } from '../../../components/AlertBox';
import { ListItemContainer, ListItemDate, ListItemDescription, ListItemInfo, ListItemName } from '../../../components/ListItem/styles';
import { useModal } from '../../../context/ModalContext';
import { ButtonSecondary } from '../../../lib-react-components';
import { Description } from '../../../pages/SettingsView/ExportTab/styles';
export const ExtensionPairingModalContent = ({ onCopy, pairingToken, loadingPairing, copyFeedback, tokenCreationDate, fingerprint }) => {
    ...
    <${ModalContainer}>
      ...
      <${ModalContent}>
        ...
        <${AlertBox}
          message=${i18n._('Security Note: Only enter this token in the official PearPass browser extension. Never share it with anyone or enter it on websites.')}
        />
        <${Description}
          style=${{
        display: 'block',
