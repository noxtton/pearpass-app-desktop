...
export const ConfirmationModalContent = (props) => {
    ...
    const { title = i18n._('Are you sure?'), text = i18n._('Are you sure you want to proceed?'), primaryAction, secondaryAction, primaryLabel = i18n._('Confirm'), secondaryLabel = i18n._('Cancel') } = props;
