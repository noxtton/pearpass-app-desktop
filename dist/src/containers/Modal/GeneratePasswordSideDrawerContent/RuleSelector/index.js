 ...
 * }} props
 */
export const RuleSelector = ({ rules, selectedRules, setRules, isSwitchFirst = false, stretch = true }) => {
    const isAllRuleSelected = Object.values(selectedRules).every((value) => value === true);
    ...
    return html `${rules.map((rule) => html `<${SwitchWithLabel}
        label=${rule.label}
