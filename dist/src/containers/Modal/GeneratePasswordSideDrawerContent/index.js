...
import { generatePassphrase, generatePassword } from 'pearpass-utils-password-generator';
...
export const GeneratePasswordSideDrawerContent = ({ onPasswordInsert }) => {
    ...
    const pass = useMemo(() => {
        if (selectedOption === 'passphrase') {
            return generatePassphrase(selectedRules.passphrase.capitalLetters, selectedRules.passphrase.symbols, selectedRules.passphrase.numbers, selectedRules.passphrase.words);
        }
