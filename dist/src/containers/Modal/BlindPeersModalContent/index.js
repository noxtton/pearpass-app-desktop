...
import { BLIND_PEER_FORM_NAME, BLIND_PEERS_FORM_NAME, BLIND_PEER_TYPE } from 'pearpass-lib-constants';
import { RadioSelect } from '../../../components/RadioSelect';
import { ButtonPrimary, ButtonSecondary, ButtonSingleInput, CompoundField, DeleteIcon, InputField, PlusIcon } from '../../../lib-react-components';
import { ModalContent } from '../ModalContent';
import { ActionsContainer, ContentWrapper, FormWrapper, HeaderWrapper } from './styles';
...
export const BlindPeersModalContent = ({ onConfirm, onClose }) => {
    ...
    const { value: blindPeersList, addItem, registerItem, removeItem } = registerArray(BLIND_PEERS_FORM_NAME);
    const radioOptions = [
    ...
    >
      <${ContentWrapper}>
        ...
        <${FormWrapper} isOpen=${selectedOption === PERSONAL}>
          <${CompoundField}>
            ${blindPeersList.map((blindPeer, index) => html `
