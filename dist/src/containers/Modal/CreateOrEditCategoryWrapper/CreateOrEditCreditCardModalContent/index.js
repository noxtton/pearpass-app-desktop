...
import { ButtonLittle, ButtonSingleInput, CalendarIcon, CreditCardIcon, DeleteIcon, ImageIcon, InputField, NineDotsIcon, PasswordField, SaveIcon, UserIcon } from '../../../../lib-react-components';
 ...
 * }} props
 */
export const CreateOrEditCreditCardModalContent = ({ initialRecord, selectedFolder, onTypeChange }) => {
    ...
    const schema = Validator.object({
        ...
        number: Validator.string().numeric(i18n._('Number on card must be a number')),
      ...
      <${FormWrapper}>
        ...
        <${FormGroup}>
          ...
          <${PasswordField}
            ...
            onChange=${(value) => handleNumericInputChange(value, 'securityCode')}
          />
