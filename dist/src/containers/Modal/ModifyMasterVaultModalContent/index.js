...
import { Content, InputLabel, InputWrapper, ModalActions, ModalTitle } from './styles';
import { useLoadingContext } from '../../../context/LoadingContext';
import { ButtonPrimary, ButtonSecondary, PearPassPasswordField } from '../../../lib-react-components';
...
export const ModifyMasterVaultModalContent = () => {
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            setIsLoading(false);
            logger.error('ModifyMasterVaultModalContent', 'Error updating master password:', error);
            setErrors({
