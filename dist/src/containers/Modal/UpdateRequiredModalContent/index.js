...
import { ButtonWrapper, Container, Description, Timer, TimerTitle, TimerWrapper, Title } from './styles';
...
export const UpdateRequiredModalContent = ({ onUpdate }) => {
    ...
    <${Description}>
      ${i18n._('Find out what exciting features and updates await you in this version.')}
    <//>
