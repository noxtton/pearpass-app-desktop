...
import { CopyIcon, EmailIcon, InputField, PhoneIcon, UserIcon } from '../../../lib-react-components';
...
export const IdentityDetailsForm = ({ initialRecord, selectedFolder }) => {
    ...
    const hasPassport = hasPassportFullName ||
        hasPassportNumber ||
        ...
        hasPassportGender ||
        hasPassportPicture;
    const hasIdCard = hasIdCardNumber ||
        hasIdCardDateOfIssue ||
        hasIdCardExpiryDate ||
        hasIdCardIssuingCountry ||
        hasIdCardPicture;
    const hasDrivingLicense = hasDrivingLicenseNumber ||
