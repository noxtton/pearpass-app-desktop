...
import { AdditionalItems, AttachmentName, IconWrapper, InputAreaWrapper, Label, MainWrapper, Wrapper } from './styles';
...
export const AttachmentField = ({ attachment, label, additionalItems, testId }) => {
    ...
    const handleDownload = (e) => {
        ...
        if (isImage) {
            setModal(html `<${DisplayPictureModalContent}
          url=${url}
