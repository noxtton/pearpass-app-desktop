...
jest.mock('../styles', () => ({
    PassPraseSettingsContainer: ({ children }) => (_jsx("div", { "data-testid": "settings-container", children: children })),
    PassPraseSettingsRandomWordContainer: ({ children }) => (_jsx("div", { "data-testid": "random-word-container", children: children })),
    PassPraseSettingsRandomWordText: ({ children }) => (_jsx("div", { "data-testid": "random-word-text", children: children })),
    SwitchWrapper: ({ children }) => (_jsx("div", { "data-testid": "switch-wrapper", children: children }))
}));
...
jest.mock('../../../components/RadioSelect', () => ({
    RadioSelect: (props) => {
        ...
        return (_jsx("button", { "data-testid": "radio-select", onClick: () => props.onChange(24), children: props.title }));
    }
}));
jest.mock('../../../components/SwitchWithLabel', () => ({
    SwitchWithLabel: (props) => {
        mockSwitchWithLabelSpy(props);
        return (_jsx("button", { "data-testid": "switch-with-label", onClick: () => props.onChange(true), disabled: props.disabled, children: "toggle" }));
    }
}));
describe('PassPhraseSettings', () => {
    const renderComponent = (overrideProps = {}) => {
        ...
        const utils = render(_jsx(ThemeProvider, { children: _jsx(PassPhraseSettings, { ...props }) }));
        return { ...utils, props };
    };
    beforeEach(() => {
    ...
    test('invokes setSelectedType when RadioSelect triggers onChange', () => {
        ...
        expect(props.setSelectedType).toHaveBeenCalledWith(PASSPHRASE_WORD_COUNTS.STANDARD_24);
    });
...
//# sourceMappingURL=PassPhraseSettings.test.js.map