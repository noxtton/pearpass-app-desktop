    ...
    >
      ...
      ${visible &&
        ...
        <${BannerBox}
          ...
          message=${t('Install our browser extension to autofill passwords, save new logins in a click, and log in instantly,right where you browse.')}
          highlightedDescription=${t('No more copy-paste. No more interruptions. Just seamless security.')}
