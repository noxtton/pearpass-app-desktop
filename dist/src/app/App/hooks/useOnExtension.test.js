...
describe('UseOnExtensionExit', () => {
    ...
    it('should add and remove extension-exit listener on mount/unmount', () => {
        ...
        expect(addEventListenerSpy).toHaveBeenCalledWith(HANDLER_EVENTS.extensionExit, expect.any(Function));
        unmount();
        expect(removeEventListenerSpy).toHaveBeenCalledWith(HANDLER_EVENTS.extensionExit, expect.any(Function));
    });
...
//# sourceMappingURL=useOnExtension.test.js.map