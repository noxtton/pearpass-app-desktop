...
import { isNativeMessagingIPCRunning, startNativeMessagingIPC, stopNativeMessagingIPC } from '../services/nativeMessagingIPCServer';
import { getNativeMessagingEnabled, setNativeMessagingEnabled } from '../services/nativeMessagingPreferences';
import { getFingerprint, getOrCreateIdentity, getPairingCode, resetIdentity } from '../services/security/appIdentity';
import { clearAllSessions } from '../services/security/sessionStore.js';
import { setupNativeMessaging, killNativeMessagingHostProcesses, cleanupNativeMessaging } from '../utils/nativeMessagingSetup';
export const useConnectExtension = () => {
    ...
    const [isBrowserExtensionEnabled, setIsBrowserExtensionEnabled] = useState(getNativeMessagingEnabled() && isNativeMessagingIPCRunning());
    ...
    const toggleBrowserExtension = async (isOn) => {
        if (isOn) {
            ...
            return handleSetupExtension()
                ...
                setModal(html `<${ExtensionPairingModalContent}
...
//# sourceMappingURL=useConnectExtension.js.map