 ...
 * }>}}
 */
export const useRecordActionItems = ({ excludeTypes = [], record, onSelect, onClose } = {}) => {
    ...
    const defaultActions = [
        ...
        {
            name: i18n._(record?.isFavorite ? 'Remove from Favorites' : 'Mark as favorite'),
            type: 'favorite',
...
//# sourceMappingURL=useRecordActionItems.js.map