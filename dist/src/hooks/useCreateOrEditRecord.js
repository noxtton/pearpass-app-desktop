...
export const useCreateOrEditRecord = () => {
    ...
    const getModalContentByRecordType = ({ recordType, initialRecord, selectedFolder }) => html `
  ...
  `;
    ...
    const handleCreateOrEditRecord = ({ recordType, initialRecord, selectedFolder, setValue }) => {
        if (recordType === 'password') {
        ...
        setModal(getModalContentByRecordType({ recordType, initialRecord, selectedFolder }));
    };
    return {
        handleCreateOrEditRecord
    };
};
//# sourceMappingURL=useCreateOrEditRecord.js.map