...
export const usePearUpdate = () => {
    ...
    const showUpdateRequiredModal = () => {
        ...
        setModal(html `<${UpdateRequiredModalContent} onUpdate=${handleUpdateApp} />`, { closable: false });
...
function hasNonIgnoredChanges(diff) {
    return diff?.some(({ key: file }) => file.startsWith('/src') &&
...
//# sourceMappingURL=usePearUpdate.js.map