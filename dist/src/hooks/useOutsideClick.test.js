...
describe('useOutsideClick', () => {
    ...
    test('should remove event listeners on unmount', () => {
        ...
        const mockOnOutsideClick = jest.fn();
        const { unmount } = renderHook(() => useOutsideClick({ onOutsideClick: mockOnOutsideClick }));
        unmount();
    ...
    test('should call onOutsideClick when clicking outside the ref element', () => {
        const mockOnOutsideClick = jest.fn();
        const { result } = renderHook(() => useOutsideClick({ onOutsideClick: mockOnOutsideClick }));
...
//# sourceMappingURL=useOutsideClick.test.js.map