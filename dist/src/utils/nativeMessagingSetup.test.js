...
import { setupNativeMessaging, getNativeHostExecutableInfo, generateNativeHostExecutable, getNativeMessagingLocations, cleanupNativeMessaging, killNativeMessagingHostProcesses } from './nativeMessagingSetup';
// Mock dependencies
jest.mock('os');
...
describe('getNativeHostExecutableInfo', () => {
    ...
    it('should throw error for unsupported platform', () => {
        ...
        expect(() => getNativeHostExecutableInfo()).toThrow('Unsupported platform: freebsd');
    });
});
describe('generateNativeHostExecutable', () => {
    ...
    it('should generate executable for macOS', async () => {
        os.platform.mockReturnValue('darwin');
        const result = await generateNativeHostExecutable('/mock/path/pearpass-native-host.sh');
        expect(result.success).toBe(true);
        expect(fs.writeFile).toHaveBeenCalled();
        expect(fs.chmod).toHaveBeenCalledWith('/mock/path/pearpass-native-host.sh', 0o755);
    ...
    it('should generate executable for Windows', async () => {
        os.platform.mockReturnValue('win32');
        const result = await generateNativeHostExecutable('C:/mock/path/pearpass-native-host.cmd');
        expect(result.success).toBe(true);
        expect(fs.writeFile).toHaveBeenCalled();
...
describe('getNativeMessagingLocations', () => {
    ...
    it('should throw error for unsupported platform', () => {
        ...
        expect(() => getNativeMessagingLocations()).toThrow('Unsupported platform: solaris');
    });
});
...
describe('setupNativeMessaging', () => {
    ...
    it('should succeed on linux and write manifest files', async () => {
        ...
        expect(result.success).toBe(true);
        expect(result.message).toMatch(/Native messaging host installed successfully/);
...
//# sourceMappingURL=nativeMessagingSetup.test.js.map