...
describe('extractDomainName', () => {
    ...
    it('extracts domain from URL with path and query', () => {
        expect(extractDomainName('https://www.testsite.com/path?query=1')).toBe('testsite');
    });
    it('extracts domain from URL with fragment', () => {
        expect(extractDomainName('https://www.testsite.com/#fragment')).toBe('testsite');
    });
...
//# sourceMappingURL=extractDomainName.test.js.map