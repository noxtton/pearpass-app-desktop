...
import { MainWrapper, Label, Input, AdditionalItems, IconWrapper, DefaultInputWrapper, OutlineInputWrapper, NoticeWrapper, InputAreaWrapper, InputOverlay, InsideWrapper } from './styles';
 ...
 * }} props
 */
export const InputField = ({ value, onChange, icon, label, error, additionalItems, belowInputContent, placeholder, isDisabled, onClick, type = 'text', variant = 'default', overlay, autoFocus, testId = 'input-field', onPaste }) => {
