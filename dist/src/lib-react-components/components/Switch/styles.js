...
export const SwitchBackground = styled.div.withConfig({
  ...
  width: 30px;
  height: 16px;
  background-color: ${({ theme, isOn }) => isOn ? theme.colors.grey400.mode1 : theme.colors.grey100.mode1};
  border-radius: 8px;
  position: relative;
...
export const SwitchThumb = styled.div.withConfig({
  ...
  width: 16px;
  height: 16px;
  background-color: ${({ isOn, theme }) => isOn ? theme.colors.primary400.mode1 : theme.colors.grey400.mode1};
  border: 1px solid
    ${({ theme, isOn }) => isOn ? theme.colors.primary400.mode1 : theme.colors.grey200.mode1};
  border-radius: 50%;
  position: absolute;
  top: -1px;
