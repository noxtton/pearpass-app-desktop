...
import { checkPassphraseStrength, checkPasswordStrength } from 'pearpass-utils-password-check';
 ...
 * }} props
 */
export const PasswordField = ({ value, onChange, label, error, passType = 'password', additionalItems, belowInputContent, placeholder, isDisabled, hasStrongness = false, onClick, variant = 'default', icon, testId = 'password-field' }) => {
    ...
    const getPasswordStrongness = () => {
        ...
        const { success, type, strengthType, strengthText } = passType === 'password'
