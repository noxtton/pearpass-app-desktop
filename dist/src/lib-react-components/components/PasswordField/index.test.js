...
const DummyAdditionalItem = () => (_jsx("div", { "data-testid": "additional-item", children: "Additional" }));
describe('PasswordField Component', () => {
    const setup = (props) => render(_jsx(ThemeProvider, { children: _jsx(PasswordField, { ...props }) }));
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    test('renders additionalItems if provided', () => {
        const { getByTestId } = setup({
            ...
            placeholder: 'Enter password',
            onChange: jest.fn(),
            additionalItems: _jsx(DummyAdditionalItem, {})
        });
