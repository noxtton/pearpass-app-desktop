...
import { ButtonWrapper, CardContainer, CardTitle, Description, InputGroup, InputLabel, RadioGroup, RadioText, RadioTextBold, Title, RequirementsContainer, BulletList, BulletItem, NoteText } from './styles';
import { AlertBox } from '../../../components/AlertBox';
import { LOCAL_STORAGE_KEYS } from '../../../constants/localStorage';
import { useGlobalLoading } from '../../../context/LoadingContext';
import { useRouter } from '../../../context/RouterContext';
import { useTranslation } from '../../../hooks/useTranslation';
import { ButtonPrimary, ButtonRadio, PearPassPasswordField } from '../../../lib-react-components';
...
export const CardCreateMasterPassword = () => {
    ...
    const { onChange: onPasswordChange, ...passwordRegisterProps } = register('password');
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            logger.error('useGetMultipleFiles', 'Error creating master password:', error);
        }
    };
    ...
    <${CardContainer} onSubmit=${handleSubmit(onSubmit)}>
      <${CardTitle}>
        ...
        <${Description}>
          ${t('The first thing to do is create a Master password to secure your account. You’ll use this password to access PearPass. ')}
        <//>
      <//>
      ...
      <${AlertBox}
        message=${t('Don’t forget your master password. It’s the only way to access your vault. We can’t help recover it. Back it up securely.')}
      />
