...
import { Header, InputContainer, LoadVaultCard, LoadVaultInput, LoadVaultNotice, LoadVaultTitle } from './styles';
...
export const CardLoadVault = () => {
    ...
    const { pairActiveVault, cancelPairActiveVault, isLoading: isPairing } = usePair();
