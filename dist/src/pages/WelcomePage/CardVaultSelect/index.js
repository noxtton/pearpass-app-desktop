...
import { ButtonWrapper, CardContainer, CardNoVaultsText, CardTitle, ImportContainer, ImportText, Title, VaultsContainer } from './styles';
import { ListItem } from '../../../components/ListItem';
import { useRouter } from '../../../context/RouterContext';
import { ButtonPrimary, ButtonSecondary, CommonFileIcon } from '../../../lib-react-components';
    ...
    <${CardContainer}>
      ...
      ${hasVaults
        ...
        : html `<${CardNoVaultsText}>
            ${i18n._('Now create a secure vault or load an existing one to get started.')}
          <//> `}
