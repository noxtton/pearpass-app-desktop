...
import { CardContainer, Header, Title, Description, TimerContainer, TimerLabel, TimerValue } from './styles';
    ...
    <${CardContainer}>
      ...
      <${TimerContainer}>
        ...
        <${TimerValue}>
          ${!isLoading &&
        html `<${Timer}
              initialSeconds=${Math.ceil((masterPasswordStatus?.lockoutRemainingMs ?? 0) / 1000)}
              onFinish=${onFinish}
            />`}
        </>
      </>
