...
import { AccordionContent, AccordionTrigger, ButtonWrapper, CardTitle, FieldWrapper, Form, InputsContainer, Label, Title } from './styles';
import { useGlobalLoading } from '../../../context/LoadingContext';
import { useRouter } from '../../../context/RouterContext';
import { ButtonPrimary, ButtonRoundIcon, ButtonSecondary, PearPassInputField, PearPassPasswordField } from '../../../lib-react-components';
...
export const CardNewVaultCredentials = () => {
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            setIsLoading(false);
            logger.error('CardNewVaultCredentials', 'Error creating master password:', error);
        }
    };
    return html `
