...
import { sendGoogleFormFeedback, sendSlackFeedback } from 'pear-apps-lib-feedback';
...
import { GOOGLE_FORM_KEY, GOOGLE_FORM_MAPPING, SLACK_WEBHOOK_URL_PATH } from '../../../constants/feedback';
...
export const SettingsTab = () => {
    ...
    useEffect(() => {
        fetch('/package.json')
            ...
            .catch((error) => logger.error('useGetMultipleFiles', 'Error fetching package.json:', error));
    }, []);
    return html `
