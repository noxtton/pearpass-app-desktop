...
import { BlackBackground, BottomGradient, ButtonContainer, ContentContainer, LogoContainer, LogoImage, PearPass, ProgressContainer, ProgressItem, StrongText } from './styles';
        ...
        `;
          ...
          <${TutorialContainer}
            ...
            description=${[
              ...
              >`,
                    i18n._('Store everything from passwords to cards, IDs, and notes.'),
                    html `<${StrongText}
