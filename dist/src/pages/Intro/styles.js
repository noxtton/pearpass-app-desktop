...
export const BlackBackground = styled.div `
  ...
  width: 100%;
  height: 100%;
  background-color: ${({ theme, pageIndex }) => pageIndex === 0 || pageIndex === 5 ? '#010702' : theme.colors.black.mode1};
...
export const ProgressItem = styled.div `
  ...
  background-color: ${({ isSelected, theme }) => isSelected ? theme.colors.primary400.mode1 : 'transparent'};

  border-radius: 15px;
  border: 1px solid
    ${({ isSelected, theme }) => isSelected ? theme.colors.primary400.mode1 : theme.colors.grey100.mode1};
