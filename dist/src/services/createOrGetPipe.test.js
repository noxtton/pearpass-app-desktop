...
describe('createOrGetPipe', () => {
    ...
    it('creates a new pipe when none exists', () => {
        ...
        expect(mockRun).toHaveBeenCalledWith('https://example.com/node_modules/pearpass-lib-vault-core/src/worklet/app.js');
...
//# sourceMappingURL=createOrGetPipe.test.js.map