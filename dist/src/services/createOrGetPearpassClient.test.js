...
describe('createOrGetPearpassClient', () => {
    ...
    it('should instantiate PearpassVaultClient with correct arguments', () => {
        ...
        expect(PearpassVaultClient).toHaveBeenCalledWith(mockIpc, mockStoragePath, mockOpts);
        expect(client).toBeInstanceOf(PearpassVaultClient);
    });
    it('should reuse the same instance if called multiple times', () => {
        const firstClient = createOrGetPearpassClient(mockIpc, mockStoragePath, mockOpts);
        const secondClient = createOrGetPearpassClient(mockIpc, mockStoragePath, mockOpts);
...
//# sourceMappingURL=createOrGetPearpassClient.test.js.map