...
describe('getClipboardContent', () => {
    ...
    it('should get clipboard content on Windows using powershell', async () => {
        ...
        expect(spawn).toHaveBeenCalledWith('powershell', ['-command', 'Get-Clipboard -Raw'], { shell: true });
    ...
    it('should fallback to xclip on Linux if xsel fails', async () => {
        ...
        expect(spawn).toHaveBeenCalledWith('xclip', ['-selection', 'clipboard', '-o'], { shell: true });
...
//# sourceMappingURL=clipboardCleanup.test.js.map