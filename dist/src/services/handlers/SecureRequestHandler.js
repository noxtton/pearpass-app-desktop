...
import { recordIncomingSeq, decryptWithSession, encryptWithSession } from '../security/sessionManager.js';
...
export class SecureRequestHandler {
    ...
    async handle(params) {
        ...
        const result = await this.methodRegistry.execute(request.method, request.params, { client: this.client });
        // Encrypt response
...
//# sourceMappingURL=SecureRequestHandler.js.map