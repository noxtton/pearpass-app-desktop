...
import { getOrCreateIdentity, getFingerprint, verifyPairingToken, resetIdentity } from '../security/appIdentity.js';
...
export class SecurityHandlers {
    ...
    async nmBeginHandshake(params) {
        ...
        if (!extEphemeralPubB64)
            throw new Error('Missing extEphemeralPubB64');
...
//# sourceMappingURL=SecurityHandlers.js.map