...
import { randomBytes, concatBytes, createSession, getSession } from './sessionStore.js';
/**
...
export const beginHandshake = async (client, extensionEphemeralPublicKeyB64) => {
    ...
    const ed25519PrivateKeyBytes = new Uint8Array(edBuffer.slice(sodium.crypto_sign_PUBLICKEYBYTES, sodium.crypto_sign_PUBLICKEYBYTES + sodium.crypto_sign_SECRETKEYBYTES));
...
export const recordIncomingSeq = (sessionId, seq) => {
    ...
    if (seq <= session.lastRecvSeq)
        throw new Error('ReplayDetected');
