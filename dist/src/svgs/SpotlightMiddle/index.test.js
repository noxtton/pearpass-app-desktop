...
describe('SpotlightMiddle', () => {
    ...
    it('renders with default props', () => {
        const { container } = render(_jsx(SpotlightMiddle, {}));
    ...
    it('accepts custom width and height props', () => {
        const { container } = render(_jsx(SpotlightMiddle, { width: "200", height: "300" }));
        const svg = container.querySelector('svg');
        expect(svg).toBeInTheDocument();
    ...
    it('accepts custom fill prop', () => {
        const { container } = render(_jsx(SpotlightMiddle, { fill: "#FF0000" }));
        const svg = container.querySelector('svg');
        expect(svg).toBeInTheDocument();
